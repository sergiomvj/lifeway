        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {upcomingTools.map((tool) => {
              const IconComponent = tool.icon;
              return (
                <Card key={tool.id} className="h-full border-2 border-dashed border-gray-300 opacity-75">
                  <CardContent className="p-0">
                    <div className={`${tool.bgColor} p-8 text-center relative overflow-hidden opacity-60`}>
                      {/* Background decoration */}
                      <div className="absolute inset-0 opacity-10">
                        <div className="absolute top-4 right-4 w-16 h-16 border border-white rounded-full"></div>
                        <div className="absolute bottom-4 left-4 w-12 h-12 border border-white rounded-full"></div>
                    ...
                    <div className="p-6 bg-gray-50">
                      <div className="flex items-center justify-center">
                        <span className="text-gray-500 font-medium font-figtree text-sm">
                          Em breve...
                        </span>
                      </div>
                    </div>
